...
> **Historical archive:** this repository intentionally preserves multiple generations of the project. Some folders contain original 2004-2005 sources, others contain later working copies or the 2026 English/Windows 11 restoration. They should not be assumed to represent one perfectly synchronized release tree. Looking at VB6 source code from more than two decades ago, I have to admit that I sometimes feel like a dinosaur.
